...
0 ?. [ await ] [ 0 ] ; 
0 ?. [ await ||= 0 ] ; 
0 ?. [ typeof `` ] [ class await extends await { } ] ; 
0 ?. [ void await . x ] . x ; 
0 ?. [ void await ] [ 0 ] ; 
0 ?. x ( 0 , ... - await , ) ; 
0 ?. x ( 0 , ... -- await , ) ; 
0 ?. x ( 0 , ... 0 instanceof await , ) ; 
0 ?. x ( 0 , ... 0 instanceof { [ Symbol . hasInstance ] : ( ... await ) => 0n } , ) ; 
0 ?. x ( 0 , ... 0 instanceof { [ Symbol . hasInstance ] : ( ... await ) => 1 } , ) ; 
0 ?. x ( 0 , ... 0 instanceof { [ Symbol . hasInstance ] : ( ... await ) => 1n } , ) ; 
...
class await { } for ( var x of await ) ; 
...
for ( let x ; await || 0 ; 0 ) ; 
for ( let x ; await ||= 0 ; ) ; 
for ( let x ; class x extends await { ; } ; ) ; 
...
let [ { } = await ] = '' ; 
let await ; await ; 
let await ; class x extends await { ; } 
let await ; var [ ] = await ; 
...
let x , await = class extends await { ; } ; 
...
let x = async x => ~ + await { [ Symbol . toPrimitive ] : ( ) => { throw [ ] . x -- ; } } + await /a/ ; x ( ) ; 
let x = await != '' ; 
let x = await !== 0 ; 
let x = await !== x > 0 ; 
let x = await % 0 ; 
...
new class x { 0 = 0 % await ; } ; 
new class x { 0 = 0 % super [ await ] ; } ; 
new class x { 0 = 0 . x ??= await ; } ; 
new class x { 0 = 0 > await ; } ; 
new class x { 0 = 0 >>> await ; } ; 
new class x { 0 = 0 ? 0 : await ; } ; 
new class x { 0 = 0 ^ 0 != await ; } ; 
new class x { 0 = 0 ^ await ; } ; 
new class x { 0 = 0 | await ; } ; 
new class x { 0 = 0 | super [ await ] ; } ; 
new class x { 0 = 1 && await ; } ; 
new class x { 0 = 1 ? await : 0 ; } ; 
new class x { 0 = 1n + await ; } ; 
new class x { 0 = `${ await }` ; } ; 
new class x { 0 = `${ super [ await ] }` ; } ; 
new class x { 0 = await & 0 ; } ; 
new class x { 0 = await && 0 ; } ; 
new class x { 0 = await ** 0 ; } ; 
new class x { 0 = await . x && 0 ; } ; 
new class x { 0 = await / 0 ; } ; 
new class x { 0 = await ; } ; 
new class x { 0 = await <= 0 ; } ; 
new class x { 0 = await >>> 0 ; } ; 
new class x { 0 = await ? 0 : 0 ; } ; 
new class x { 0 = await ?? 0 ; } ; 
new class x { 0 = await ^ 0 != 0 ; } ; 
new class x { 0 = await | 0 ; } ; 
new class x { 0 = new 0 ? await : 0 ; } ; 
new class x { 0 = super [ '' ] ?? await ; } ; 
new class x { 0 = super [ - await ] ; } ; 
new class x { 0 = super [ 0 % await ] ; } ; 
new class x { 0 = super [ 0 == await ] ; } ; 
new class x { 0 = super [ [ ] = await ] ; } ; 
new class x { 0 = super [ `${ await }` ] ; } ; 
new class x { 0 = super [ await & 0 ] ; } ; 
new class x { 0 = super [ await = 0 ] ; } ; 
new class x { 0 = super [ await >= 0 ] ; } ; 
new class x { 0 = super [ await ] && 0 ; } ; 
new class x { 0 = super [ await ] ; } ; 
new class x { 0 = super [ await | 0 ] ; } ; 
new class x { 0 = super [ x = await %= 0 ] ; } ; 
new class x { 0 = super [ x = await ] ; } ; 
new class x { 0 = super [ ~ await ] ; } ; 
new class x { 0 = ~ await && 0 ; } ; 
new class { 0 = 0 & super [ 0 , super [ await ] ] ; } ; 
new class { 0 = 0 & super [ await , 0 ?. x ] ; } ; 
new class { 0 = 0 & super [ await ] ; } ; 
new class { 0 = 0 <= 0 && await ; } ; 
new class { 0 = 0 <= { [ Symbol . toPrimitive ] : false } && await ; } ; 
new class { 0 = 0 in super [ await ] ; } ; 
new class { 0 = 0 instanceof await -- ; } ; 
new class { 0 = 0 instanceof super [ await ] ; } ; 
new class { 0 = 0 | { [ Symbol . toPrimitive ] : await => { } } ; } ; 
new class { 0 = 0 || super [ await ] ; } ; 
new class { 0 = [ ] ? super [ await ] : 0 ; } ; 
new class { 0 = `${ super [ await ] }` ; } ; 
new class { 0 = await ; } ; 
new class { 0 = await === 0 ; } ; 
new class { 0 = await instanceof 0 ; } ; 
new class { 0 = new super [ await ] ( ) > '' ; } ; 
new class { 0 = super [ await & 0 ] ; } ; 
new class { 0 = super [ await ++ ] . x ; } ; 
new class { 0 = super [ await -= 0 ] ; } ; 
new class { 0 = super [ await ] -- ; } ; 
new class { 0 = super [ await ] ; } ; 
new class { 0 = super [ await ] << 0 ; } ; 
...
switch ( 0 ) { case 1 / 0 : default : case 0 : await ; } 
