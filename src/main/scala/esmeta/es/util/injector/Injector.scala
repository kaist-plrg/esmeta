...
class Injector(
  ...
  lazy val conformTest: ConformTest =
    ConformTest(0, transpiled.getOrElse(original), exitTag, isAsync, assertions)

  /** injected script */
  // TODO: this will eventually be generated by stringifier
  ...
  /*
    ...
    if (normalExit)
      ...
      assertions.foreach(app :> _.toString _.getClass.getName)
      if (isAsync) endAsync
    app.toString
   */
