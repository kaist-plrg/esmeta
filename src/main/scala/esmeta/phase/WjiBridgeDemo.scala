    ...
    val runHost = Func(
      ...
      body = ISeq(
        List(
          ...
          ILet(Name("store"), ERef(Field(Name("alloc"), EMath(0)))),
          ILet(Name("faddr"), ERef(Field(Name("alloc"), EMath(1)))),
          ...
          ILet(Name("store"), ERef(Field(Name("inv"), EMath(0)))),
          ILet(Name("result"), ERef(Field(Name("inv"), EMath(1)))),
          IAssign(Global("Store"), ERef(Name("store"))),
